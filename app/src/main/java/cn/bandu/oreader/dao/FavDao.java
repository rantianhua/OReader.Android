...
public class FavDao extends AbstractDao<Fav, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Cateid = new Property(9, long.class, "cateid", false, "CATEID");
        public final static Property CateName = new Property(10, String.class, "cateName", false, "CATE_NAME");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'FAV' (" + //
                ...
                "'CATEID' INTEGER NOT NULL ," + // 9: cateid
                "'CATE_NAME' TEXT NOT NULL ," + // 10: cateName
    ...
    protected void bindValues(SQLiteStatement stmt, Fav entity) {
        ...
        stmt.bindLong(10, entity.getCateid());
        stmt.bindString(11, entity.getCateName());
    ...
    public Fav readEntity(Cursor cursor, int offset) {
        Fav entity = new Fav( //
            ...
            cursor.getLong(offset + 9), // cateid
            cursor.getString(offset + 10), // cateName
    ...
    public void readEntity(Cursor cursor, Fav entity, int offset) {
        ...
        entity.setCateid(cursor.getLong(offset + 9));
        entity.setCateName(cursor.getString(offset + 10));
